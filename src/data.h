...
/* breaks r8169 in 6.6 kernels
	{"/proc/sys/net/core/busy_poll", "50", 0},
	{"/proc/sys/net/core/busy_read", "50", 0},
*/
	...
	{"/sys/devices/system/cpu/cpu*/power/energy_perf_bias", "balance_performance", 0}, 
